...
class LeagueStaff(commands.Cog):
    ...
    async def leaguestaff(self, ctx):
        ...
        for member in members:
            embed.add_field(name="<:swarm:1058011486116646942> Staff Member", value=member.mention, inline=True)
        embed.set_footer(text=f"<:swarm:1058011486116646942> Total staff members: {len(members)}")
